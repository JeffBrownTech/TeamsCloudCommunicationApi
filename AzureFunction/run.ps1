...
# Modify strings in brackets {} to match application settings for your Azure Function
...
foreach ($record in $pstnRecords) {
    ...
    # Modify output binding name to Azure table storage
    Push-OutputBinding -Name {outputBindingName} -Value $tableData
    $counter++
}